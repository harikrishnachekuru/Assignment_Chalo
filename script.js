...
function readFormData() {
    ...
    formData["Route"] = document.getElementById("Route").value;
...
function insertNewRecord(data) {
    ...
    cell2.innerHTML = data.Direction;
    cell3 = newRow.insertCell(2);
    cell3.innerHTML = data.Route;
...
function onEdit(td) {
    ...
    document.getElementById("Route").value = selectedRow.cells[2].innerHTML;
    document.getElementById("Status").value = selectedRow.cells[3].innerHTML;
}
function updateRecord(formData) {
    selectedRow.cells[0].innerHTML = formData.fullName;
    selectedRow.cells[1].innerHTML = formData.Direction;
    selectedRow.cells[2].innerHTML = formData.Route;
